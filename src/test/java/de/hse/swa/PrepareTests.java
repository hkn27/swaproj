...
//		em.createNativeQuery("INSERT INTO TLICENSE (IDLICENSE, EXPIRATIONDATE, LICENSEKEY, LICENSECOUNT, IP1, IP2, IP3, IP4, TSCID) VALUES (1, "20.1.2020", "key", 6, "123.111.111.111", "121.111.111.111", "1.3.4.5", "1.1.1.1")").executeUpdate();
